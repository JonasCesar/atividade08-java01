...
public class ImprimirExcluirTodosPasseioTela extends JFrame {
	
	private static ImprimirExcluirTodosPasseioTela imprimirExcluirTodosTela;
	...
	private ImprimirExcluirTodosPasseioTela() {
		super("Imprimir/Excluir todos");
		inicializaComponentes();
		setLocationRelativeTo(null);
	}
	
	public static ImprimirExcluirTodosPasseioTela getImprimirExcluirTodosPasseioTela() {
		if(imprimirExcluirTodosTela == null) {
			imprimirExcluirTodosTela = new ImprimirExcluirTodosPasseioTela();
		}
